...
if (Meteor.isClient) {
  ...
  Template.home.events({
    'click .moreInfoContainer': function(event, template){
      $("#about-me").toggleClass('hide');
      $("#about-me").toggleClass('show');
      $("#info").toggleClass("show");
      $("#info").toggleClass("hide");
      $(".zmdi.zmdi-close-circle-o").toggleClass("rotate");
      $(".zmdi.zmdi-close-circle-o").toggleClass("unrotate");
    }
  })
  /* Threejscube template */
  Template.threejscube.onRendered(function() {
  ...
  var inputWord = undefined;
  var drawName = undefined;
  var updateBubbles = undefined;
  var letterColors = undefined;

  Template.animate.events({
    "keyup #word-input": function(event, template) {
      var word = event.currentTarget.value;

      inputWord = word;
      drawName(inputWord, letterColors);
    }
  })
  ...
  Template.animate.onRendered(function() {
    ...
    drawName = function(name, letterColors) {
  ...
  var hasntBeenRendered = true;
  Template.animate.onRendered(function() {
    if (hasntBeenRendered) {
      bounceBubbles();
      hasntBeenRendered = false;
    }
  })
}
